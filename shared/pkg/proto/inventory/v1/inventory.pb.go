...
type GetPartRequest struct {
	...
	Uuid          string                 `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"` // Идентификатор запрашиваемой детали
...
type GetPartResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Part          *Part                  `protobuf:"bytes,1,opt,name=part,proto3" json:"part,omitempty"` // Информация о найденной детали
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Value_Int64Value struct {
	Int64Value int64 `protobuf:"varint,2,opt,name=int64_value,json=int64Value,proto3,oneof"` // Целочисленное значение
}
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x04part\x18\x01 \x01(\v2\x12.inventory.v1.PartB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x04part\"E\n" +
	"\x10ListPartsRequest\x121\n" +
	"\x06filter\x18\x01 \x01(\v2\x19.inventory.v1.PartsFilterR\x06filter\"=\n" +
	"\x11ListPartsResponse\x12(\n" +
	"\x05parts\x18\x01 \x03(\v2\x12.inventory.v1.PartR\x05parts\"\xde\x05\n" +
	"\x04Part\x12\x1c\n" +
	"\x04uuid\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\x04uuid\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\xff\x01R\x04name\x12*\n" +
	"\vdescription\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xd0\x0fR\vdescription\x12$\n" +
	...
	"dimensions\x12H\n" +
	"\fmanufacturer\x18\b \x01(\v2\x1a.inventory.v1.ManufacturerB\b\xfaB\x05\x8a\x01\x02\x10\x01R\fmanufacturer\x12$\n" +
	"\x04tags\x18\t \x03(\tB\x10\xfaB\r\x92\x01\n" +
	"\x18\x01\"\x06r\x04\x10\x01\x18@R\x04tags\x12F\n" +
	"\bmetadata\x18\n" +
	" \x03(\v2 .inventory.v1.Part.MetadataEntryB\b\xfaB\x05\x9a\x01\x02\x18\x01R\bmetadata\x12C\n" +
	"\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x13.inventory.v1.ValueR\x05value:\x028\x01\"\xaa\x01\n" +
	"\n" +
	"Dimensions\x12&\n" +
	...
	"\x06weight\x18\x04 \x01(\x01B\x0e\xfaB\v\x12\t!\x00\x00\x00\x00\x00\x00\x00\x00R\x06weight\"{\n" +
	"\fManufacturer\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\xff\x01R\x04name\x12$\n" +
	"\acountry\x18\x02 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\x80\x01R\acountry\x12%\n" +
	"\awebsite\x18\x03 \x01(\tB\v\xfaB\br\x06\xd0\x01\x01\x88\x01\x01R\awebsite\"\xa2\x01\n" +
	"\x05Value\x12#\n" +
	...
	"\n" +
	"bool_value\x18\x04 \x01(\bH\x00R\tboolValueB\v\n" +
	"\x04kind\x12\x03\xf8B\x01\"\x98\x02\n" +
	"\vPartsFilter\x12%\n" +
	"\x05uuids\x18\x01 \x03(\tB\x0f\xfaB\f\x92\x01\t\x18\x01\"\x05r\x03\xb0\x01\x01R\x05uuids\x12'\n" +
	"\x05names\x18\x02 \x03(\tB\x11\xfaB\x0e\x92\x01\v\x18\x01\"\ar\x05\x10\x01\x18\xff\x01R\x05names\x12I\n" +
	"\n" +
	"categories\x18\x03 \x03(\x0e2\x16.inventory.v1.CategoryB\x11\xfaB\x0e\x92\x01\v\x18\x01\"\a\x82\x01\x04\x10\x01 \x00R\n" +
	"categories\x12H\n" +
	"\x16manufacturer_countries\x18\x04 \x03(\tB\x11\xfaB\x0e\x92\x01\v\x18\x01\"\ar\x05\x10\x01\x18\x80\x01R\x15manufacturerCountries\x12$\n" +
	"\x04tags\x18\x05 \x03(\tB\x10\xfaB\r\x92\x01\n" +
	"\x18\x01\"\x06r\x04\x10\x01\x18@R\x04tags*v\n" +
	"\bCategory\x12\x18\n" +
